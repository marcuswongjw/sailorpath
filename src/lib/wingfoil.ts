  ...
  },
{
  ...
  {
    id: "snsc-2025-wingfoil",
    name: "Singapore National Sailing Championships 2025 — WingFoil Sprint Slalom",
    shortName: "SNSC 2025",
    ...
    format: "Sprint Slalom",
    status: "Completed",
    scoringSystem: "14 races, 2 discards",
    rulesNotes:
      "Delta Buoy Slalom course, 14 races completed, 2 discards. Awards: Open 1st-3rd, Female 1st-3rd, 18&U 1st-3rd. Per NoR 20.2: <6 entries, top boat presented.",
