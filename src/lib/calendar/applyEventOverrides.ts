...
export function applyCalendarEventOverride(
  ...
  return {
    ...
    endDate: saved.endDate || entry.endDate,
    venue: saved.venue || entry.venue,
    organizer: saved.organizer || entry.organizer,
    norUrl: saved.norUrl || entry.norUrl,
    registrationUrl: saved.registrationUrl || entry.registrationUrl,
    ...
    keyDeadlines: saved.keyDeadlines || entry.keyDeadlines,
