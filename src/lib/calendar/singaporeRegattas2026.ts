...
export const SINGAPORE_REGATTAS_2026: RegattaCalendarEntry[] = [
  ...
  },
  {
    ...
    endDate: "2026-02-22",
    boatClass: "Optimist",
    classes: ["Optimist", "ILCA 4", "ILCA 6", "ILCA 7", "29er", "420", "Techno 293", "iQFOiL", "WingFoil"],
    division: "Open",
    region: "Singapore",
    geography: "SG",
    ...
    scheduleNotes: "Pulau Ujong Regatta 2026 at National Sailing Centre. Scoring: 4 or more races completed = 1 discard.",
    totalFleetSize: 75,
  },
  {
    ...
    endDate: "2026-03-29",
    boatClass: "Optimist",
    classes: ["Optimist", "ILCA 4", "ILCA 6", "ILCA 7"],
    ...
    countsForRanking: true,
    isSelectionTrial: false,
    targetFleet: "Optimist & ILCA Fleets",
    norUrl: "https://www.racingrulesofsailing.org/documents/13551/event",
    registrationUrl: "https://www.safyc.org.sg",
    scheduleNotes: "22nd SAFYC Regatta 2026. 14–15 Feb 2026 (ILCA 4, 6, 7: 7 races, 1 discard), 28–29 Mar 2026 (Optimist Gold & Silver: 7 races, 1 discard).",
    totalFleetSize: 153,
  },
  {
    ...
    endDate: "2026-03-01",
    boatClass: "ILCA 6",
    classes: ["ILCA 4", "ILCA 6", "ILCA 7", "29er"],
    division: "Open",
    region: "Singapore",
    geography: "SG",
    ...
    countsForRanking: true,
    isSelectionTrial: false,
    targetFleet: "ILCA & 29er Fleets",
    norUrl: "https://www.csc.org.sg",
    registrationUrl: "https://www.csc.org.sg/csc-ilca-29er-championships-entry-form/",
    scheduleNotes:
      "6th CSC ILCA & 29er Open 2026 (CSC ILCA 29er Championships 2026). 28 Feb – 1 Mar 2026 at Changi Sailing Club. 7 races scheduled (max 5/day). Scoring: 5 or more races = 1 discard. Official results: ILCA 6 6 races, 1 discard, 16 entries; 29er 7 races, 1 discard, 3 entries.",
    totalFleetSize: 19,
  },
  {
  ...
  },
  {
    ...
    endDate: "2026-03-17",
    boatClass: "Optimist",
    classes: ["Optimist", "ILCA 4", "ILCA 6", "ILCA 7", "29er", "420", "Techno 293", "iQFOiL"],
    division: "National",
    region: "Singapore",
    geography: "SG",
    venue: "National Sailing Centre, East Coast",
    ...
    countsForRanking: true,
    isSelectionTrial: true,
    targetFleet: "Youth Fleets (Optimist, ILCA, 29er, Boards)",
    norUrl: "https://www.racingrulesofsailing.org/documents/13601/event",
    scheduleNotes: "Singapore Youth Sailing Championships 2026 (14–17 March 2026). Selection Trial #1 for Optimist Asian Games & Perth Camp squad, and ILCA 4 national ranking series scoring event. 1 race to constitute series; 5–9 races = 1 discard; 10+ races = 2 discards.",
    totalFleetSize: 190,
  },
  {
