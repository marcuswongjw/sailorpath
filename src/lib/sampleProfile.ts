...
> = {
  ...
  parent: {
    ...
    value:
      "Multi-athlete switcher, 2026 Selection Trials status, equipment locker alerts, pre-race morning checklist, and private notes.",
  },
  coach: {
    title: "Coach",
...
export const SAMPLE_SERIES_STANDING = {
  ...
  overallRank: 3,
  fleetSize: 100,
  /** Lowest three: 3 + 4 + 5 = 12 (DNS 12 discarded) */
  best3of5: 12,
  rScores: [
    {
      regattaId: "sr1",
    ...
    },
    {
      ...
      isOverseasCommitment: false,
      isCarryForward: false,
      regattaDate: "2026-10-11",
    },
    {
      regattaId: "sr5",
      regattaName: "NRS Final · Nov",
      score: 3,
      isDNS: false,
      isOverseasCommitment: false,
      isCarryForward: false,
      regattaDate: "2026-11-08",
    },
  ],
  trendNote: "↑ 1 place vs Jun 2026 · Best 3 of 5 = 3+4+5",
};

/** Optimist + ILCA 4 results (dual-class demo). boatClass drives class tabs. */
export const SAMPLE_RESULTS = [
  // Jul–Dec 2026 series window (aligned with SAMPLE_SERIES_STANDING)
  {
    id: "sr5",
    regattaId: "sr5",
    regattaName: "National Ranking Series Final 2026",
    regattaSlug: "sample-nrs-final-2026",
    regattaDate: "2026-11-08",
    geography: "SG",
    division: "Gold",
    boatClass: "Optimist",
  ...
  },
  {
    id: "sr4",
    regattaId: "sr4",
    regattaName: "NSC Cup Gold 2026",
    regattaSlug: "sample-nsc-cup-oct-2026",
    regattaDate: "2026-10-11",
    geography: "SG",
    division: "Gold",
    boatClass: "Optimist",
  ...
  },
  {
    id: "sr3",
    regattaId: "sr3",
    regattaName: "SAFYC Gold Regatta 2026",
    regattaSlug: "sample-safyc-gold-sep-2026",
    regattaDate: "2026-09-13",
    geography: "SG",
    division: "Gold",
    boatClass: "Optimist",
  ...
  },
  {
    id: "sr2",
    regattaId: "sr2",
    regattaName: "CSC Gold Championships 2026",
    regattaSlug: "sample-csc-gold-aug-2026",
    regattaDate: "2026-08-09",
    geography: "SG",
    division: "Gold",
    boatClass: "Optimist",
  ...
  },
  {
    id: "sr1",
    regattaId: "sr1",
    regattaName: "National Ranking Series 3 2026",
    regattaSlug: "sample-nrs3-2026",
    regattaDate: "2026-07-12",
    geography: "SG",
    division: "Gold",
    boatClass: "Optimist",
...
export const SAMPLE_PARENT_PANEL = {
  ...
  athletes: [
    {
      ...
      sailNumber: "SGP 115",
      sailNumberIlca4: "SGP 2115",
      boatClass: "Optimist Gold · ILCA 4",
      rank: 3,
      rankLabel: "Gold #3",
      avatarUrl: "/demo-kimberly-tan.jpg",
      selectionStatus: "Asian Games Team & Perth Camp Qualifier (Rank #3)",
    },
    {
      id: "sample-alex",
      name: "Alex Tan",
      ...
      rankLabel: "Silver #8",
      avatarUrl: null,
      selectionStatus: "Silver Series Top-10 Podium Contender",
    },
  ],
  selectionTrials: {
    trialsRank: 3,
  ...
  coachDebriefs: [
    {
      coachName: "Coach Lim (CSC)",
      date: "2026-06-20",
      category: "Starts",
      note: "Mid-line speed on 10s gun was excellent today. Accelerated cleanly without losing height.",
    },
    {
      coachName: "Coach Lim (CSC)",
      date: "2026-06-18",
      category: "Tactics",
      note: "Watch outgoing current near the Changi layline. Earlier mode change into flat water paid off.",
    },
  ],
  morningChecklist: [
  ...
  nextEvents: [
    {
      ...
      deadline: "Selection Event",
      norUrl: "https://singaporesailing.org",
