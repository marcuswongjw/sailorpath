      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 py-2.5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="inline-flex items-center gap-1.5 text-xs font-bold text-[var(--sp-soft-aqua)] hover:text-white transition-colors"
          ...
          <nav
            className="flex items-center gap-1 p-1 rounded-2xl bg-[#0c1f22] border border-[var(--sp-soft-aqua)]/25 self-stretch sm:self-auto overflow-x-auto shadow-inner"
          ...
          <div className="flex items-center gap-2.5 shrink-0 self-end sm:self-auto">
            <Link
              href="/login"
              className="text-xs font-bold text-[var(--sp-sailcloth)] hover:text-white px-2 py-1 transition-colors"
            >
              Sign in
            </Link>
            <Link
